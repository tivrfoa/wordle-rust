...
fn solve(ans: &str, dictionary: &Vec<&str>, qt_solved: &mut u32, qt_failed: &mut u32) {
	...
	*/
	let mut best_candidates = vec!["tower", "winch", "stark", "mayor", "tasty", "proxy", "store", "paper", "rover", "spike", "troop", "worst", "untie", "steer", "known", "kedgy", "moans", "hunky", "virls", "watch"];
	let mut attempts = 0;
